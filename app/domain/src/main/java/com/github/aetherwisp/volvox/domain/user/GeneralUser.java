...
public final class GeneralUser implements Entity<GeneralUser>, User {
    ...
    //======================================================================
    // Constructors
    private GeneralUser(final UserBuilder _builder) {
    ...
    //======================================================================
    // Classes
    public static class UserBuilder implements Builder<GeneralUser> {
        private Integer id;
        private String name;
