...
public final class Administrator implements Entity<Administrator>, User {
    ...
    private Administrator(final AdministratorBuilder _builder) {
        final AdministratorBuilder builder = Objects.requireNonNull(_builder);
    ...
    //======================================================================
    // Classes
    public static class AdministratorBuilder implements Builder<Administrator> {
        private Integer id;
        private String name;
        ...
        //======================================================================
        // Setters
        public AdministratorBuilder setId(Integer _id) {
            this.id = _id;
            return this;
        }

        public AdministratorBuilder setName(String _name) {
            this.name = _name;
            return this;
        }

        public AdministratorBuilder setLocked(boolean _locked) {
            this.locked = _locked;
            return this;
        }

        public AdministratorBuilder setExpiredAt(LocalDateTime _expiredAt) {
            this.expiredAt = _expiredAt;
            return this;
        }

        public AdministratorBuilder setPassword(Password _password) {
